...
import TvSeriesView from "../src/components/TvSeriesView";
import TvSeriesList from "../src/components/TvSeriesList";

describe("TvSeriesList", () => {
    let container;
    ...
    it("renders title", () => {
        render(<TvSeriesList />);
        expect(document.body.textContent).toContain("Tv Series");
    });
...
describe("TvServiesView", () => {
    ...
    it("renders a div with the correct id", () => {
        render(<TvSeriesView tvSeries={["hello"]} />);
